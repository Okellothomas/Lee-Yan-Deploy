...
//           </div>
//           <div className="hover:font-semibold text-md flex cursor-pointer flex-row gap-3 py-4 items-center">
//           <Link href="/client/property-purchases"><GiVikingLonghouse className="text-neutral-500" size={26} /></Link>
...
//           </div>
//           <div className="hover:font-semibold text-md flex cursor-pointer flex-row gap-3 py-4 items-center">
//           <Link href="/client/property-rentals"><GiSpookyHouse className="text-neutral-500" size={26} /></Link>
...
//           </div>
//           <div className="hover:font-semibold text-md flex cursor-pointer flex-row gap-3 py-4 items-center">
//           <Link href="/client/land-purchases"><GiIceland className="text-neutral-500" size={26} /></Link>
