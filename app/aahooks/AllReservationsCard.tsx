...
const AllReservationsCard: React.FC<ListingCardProps> = ({
    data,
    reservation,
    onAction,
    disabled,
    ...
    try {
        const response = await axios.delete(`/api/stay/${data?.id}`, {
            method: 'DELETE',
        });
...
function formatDate(dateString: any) {
  ...
  return (
      <div
        onClick={() => router.push(`/stay/${data?.id || ""}`)} // Handle null data or id
...
export default AllReservationsCard;