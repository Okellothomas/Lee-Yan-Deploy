...
import { SafeUser, safeReservation, safePropertyReservation, safeLand, safeOffer, safeLandReservation, safeOfferReservation } from "@/app/types";
...
const AllLandCard: React.FC<ListingCardProps> = ({
    data,
    reservation,
    onAction,
    disabled,
...
function formatDate(dateString: any) {
  ...
  return (
      <div
        onClick={() => router.push(`/land/${data?.id || ""}`)} // Handle null data or id
      ...
      >
          <div className="flex flex-col gap-2 w-full main-image-small-screen border-[1px] border-solid border-neutral-300 pb-1 rounded-xl">
              ...
              <div className="flex justify-between mx-2 items-center">
               ...
               <span className="text-neutral-800">Host:</span> {data.hostName} 
              </div> */}
              ...
              {/* <div className="flex justify-between mx-2 items-center">
                 <div className="font-light text-neutral-500 text-sm">
                <span className="text-neutral-800">Host email:</span> {data.hostEmail}
              </div>
              <div className="font-light text-neutral-500 text-sm">
                  <span className="text-neutral-800">Host contact:</span> {data.hostContact}
              </div> 
              </div>
              <hr /> */}
              <div className="flex justify-between mx-2 items-center">
