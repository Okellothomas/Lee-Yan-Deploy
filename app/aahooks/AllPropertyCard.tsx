...
import { SafeUser, safeReservation, safePropertyReservation, safeProperty, safeLand, safeOffer, safeLandReservation, safeOfferReservation } from "@/app/types";
...
const AllPropertyCard: React.FC<ListingCardProps> = ({
    data,
    reservation,
    onAction,
    disabled,
