...
import { SafeUser, safeReservation, safePropertyReservation, safeLandReservation, safeOfferReservation } from "@/app/types";
...
const OfferClientCard: React.FC<ListingCardProps> = ({
    data,
    reservation,
    onAction,
    disabled,
...
export default OfferClientCard;