                ...
                return (
                  <div key={cardIndex} className="grid-cols-1 pb-4 relative">
                    <div className="h-[20vh] w-full mx-auto shadow-lg rounded-lg mb-4 relative">
                      <Link href={{ pathname: '/lands-', query: { county: offer.county }}} className='text-black'>
                    ...
                    <div className="text-start relative">
                      <p className="text-sm text-gray-600 pb-1">
                        <Link href={{ pathname: '/lands-', query: { county: offer.county }}} className='text-black'>{offer.county}</Link>
                      </p>
                      <p className="text-sm text-gray-600 pb-1">
                        <Link href={{ pathname: '/lands-', query: { county: offer.county }}} className='text-black'>{listingCount} properties</Link>
                      </p>
                    </div>
                  </div>
                );
