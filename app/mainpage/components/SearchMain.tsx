        ...
        <div className="search-main-container shadow-md sm:w-[full] sm:py-1 2xl:w-[900px] xl:w-[900px] border-[1px] border-solid border-neutral-300 bg-white rounded-full py-2 px-4 flex justify-center items-center">
            ...
            <div className="search-main-container-three flex flex-col px-2 justify-between items-center gap-1 relative">
                <div className="flex flex-row items-center mt-2" ref={dropdownRef}>
                    <div className="relative w-40">
                        <label
                            htmlFor="guests"
                            className={`absolute left-2 top-1/2 transform -translate-y-1/2 text-gray-500 pointer-events-none transition-all duration-200 ease-in-out ${
                                options.adults + options.children + options.rooms !== 0 ? "opacity-0" : "opacity-100"
                            }`}
                             >
                            Add guests
                        </label>
                        <input
                            ...
                            type="text"
                            value={
                                options.adults + options.children + options.rooms === 0
                                    ? ""
                                    : `${options.adults} adults, ${options.children} children, ${options.rooms} rooms`
                            }
                            className="w-full py-2 px-2 text-gray-500 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    {openoptions && (
                        <div className="listing-rooms-main-id bg-white p-5 md:p-7 rounded-xl shadow-md absolute top-full left-0 z-10" ref={numberOfGuestsRef}>
                            <div className="flex flex-col gap-3">
                                <div className="flex items-center flex-row gap-3">
                                    <div className="text-neutral-500"><IoIosPeople size={25} /></div>
                                ...
                                <div className="flex items-center flex-row gap-3">
                                    <div className="text-neutral-500"><FaChildren size={25} /></div>
                                ...
                                <div className="flex items-center flex-row gap-3">   
                                    <div className="text-neutral-500"><PiBuildings size={25} /></div>
            ...
            <div className="px-4 items-center text-center">
                <Link href={{
                    ...
                    <button className="bg-neutral-500 p-[8px] rounded-full">
                        <span className="text-white"><IoSearch size={22} /></span>
                    </button>
                </Link>
            </div>
        </div>
