...
//                 <Link href={{ pathname: '/stay', query: { destination: searchDestination.town, county:searchDestination?.county,adults:options.adults, children:options.children, rooms:options.rooms,  
...
//             <div className="items-center w-auto text-center hover:rounded-full hover:cursor-pointer">
//                 <label htmlFor="checkout-date" className="text-md hover:cursor-pointer">Check Out</label>
//                 <DatePicker id="checkout-date" selected={checkoutDate} onChange={(date) => setCheckoutDate(date)} minDate={new Date()} placeholderText="Add date out" autoComplete="off" className="hover:cursor-pointer outline-none text-center rounded-bl-lg rounded-br-lg items-center"/>
//             </div>
//             <hr className="h-[24px] w-[0.8px] bg-neutral-400 mx-auto"></hr>
//             <div className="flex flex-col px-2 justify-between item-center gap-1 relative">
//                 <div className="flex flex-row items-center mt-2 " ref={dropdownRef}>
//                     {/* <label htmlFor="guests" className="text-right mr-4 text-gray-500">Guests:</label> */}
//                     <input
//                         id="guests"
//                         type="text"
//                         value={options.adults > 1 || options.children > 0 || options.rooms > 0 ? `${options.adults} adults, ${options.children} children, ${options.rooms} rooms` : 'Add guests'}
//                         className="w-auto py-2 px-2 text-gray-500 leading-tight focus:outline-none focus:shadow-outline overflow-hidden text-ellipsis"
//                         onClick={toggleOptions}
//                         ref={inputRef}
//                         readOnly
//                     />
