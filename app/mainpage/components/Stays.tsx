...
const Stay: React.FC = () => {
  return (
    <div className="flex flex-col items-center space-y-5">
        ...
        <div className="relative stay-first 2xl:w-[33.3333%] 2xl:h-[35vh] xl:w-[33.3333%] xl:h-[35vh]">
          ...
          <Image
            ...
            alt="Image 1"
            className="object-cover stay-first w-full h-[35vh] rounded-lg shadow-lg"
          />
        ...
        <div className="relative stay-first-sm 2xl:w-[33.3333%] 2xl:h-[35vh] xl:w-[33.3333%] xl:h-[35vh]">
      ...
      <div className="flex justify-between w-[100%] space-x-5">
        <div className="relative stay-first 2xl:w-[50%] 2xl:h-[40vh] xl:w-[50%] xl:h-[40vh]">
         <Link className='cursor-pointer' href={{ pathname: '/stay', query: { county: 'Kisumu' }}}>
          <Image
            ...
            alt="Image 4"
            className="object-cover stay-first w-full h-[40vh] rounded-lg shadow-lg"
          />
          <div className="absolute inset-0 bg-black opacity-40 rounded-lg shadow-lg"></div>
          <div className="absolute bottom-0 left-0 p-2 text-white">
