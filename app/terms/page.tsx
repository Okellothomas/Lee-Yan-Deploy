...
const DestinationPage = async ({ searchParams, tourParams }: HotelPageProps) => {
  ...
  return (
    ...
    <div className="all-destinations-main-news flex flex-col items-center justify-center text-lg font-bold">
        <h1 className="text-2xl mt-[52px] text-white"> Our Terms and Conditions </h1>
        <Container>
          <h2><strong>Terms and Conditions</strong></h2>

<p>Welcome to Lee-Yan Smart Properties!</p>

<p>These terms and conditions outline the rules and regulations for the use of Lee-Yan Smart Properties&apos;s Website, located at https://lee-yansmartproperties.com/.</p>

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Lee-Yan Smart Properties if you do not agree to take all of the terms and conditions stated on this page.</p>
...
<p>We employ the use of cookies. By accessing Lee-Yan Smart Properties, you agreed to use cookies in agreement with the Lee-Yan Smart Properties&apos;s Privacy Policy. </p>

<p>Most interactive websites use cookies to let us retrieve the user&apos;s details for each visit. Cookies are used by our website to enable the functionality of certain areas to make it easier for people visiting our website. Some of our affiliate/advertising partners may also use cookies.</p>

<h3><strong>License</strong></h3>

<p>Unless otherwise stated, Lee-Yan Smart Properties and/or its licensors own the intellectual property rights for all material on Lee-Yan Smart Properties. All intellectual property rights are reserved. You may access this from Lee-Yan Smart Properties for your own personal use subjected to restrictions set in these terms and conditions.</p>

<p>You must not:</p>
<ul>
    <li>Republish material from Lee-Yan Smart Properties</li>
    <li>Sell, rent or sub-license material from Lee-Yan Smart Properties</li>
    <li>Reproduce, duplicate or copy material from Lee-Yan Smart Properties</li>
    <li>Redistribute content from Lee-Yan Smart Properties</li>
</ul>

<p>This Agreement shall begin on the date hereof. Our Terms and Conditions were created with the help of the <a href="https://www.termsandconditionsgenerator.com/">Free Terms and Conditions Generator</a>.</p>

<p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain areas of the website. Lee-Yan Smart Properties does not filter, edit, publish or review Comments prior to their presence on the website. Comments do not reflect the views and opinions of Lee-Yan Smart Properties,its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted by applicable laws, Lee-Yan Smart Properties shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

<p>Lee-Yan Smart Properties reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate, offensive or causes breach of these Terms and Conditions.</p>
...
<p>You hereby grant Lee-Yan Smart Properties a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.</p>
...
<p>No use of Lee-Yan Smart Properties&apos;s logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
