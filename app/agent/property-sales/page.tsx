...
const AdministratorsPage = async ({ searchParams }: HotelPageProps) => {
  try {
    ...
    const reservations = (await getPropertyReservation({}))
      .filter(reservation => reservation.Property.ownerId === currentUser.id && reservation.Property.type === 'sale');
        ...
        <Container>
          <div className="grid grid-cols-6 gap-10 pt-16">
            ...
            <div className="col-span-4">
              ...
              <div className="pb-2">
                <h1 className="text-xl font-semibold">Active property sales</h1>
                </div>
