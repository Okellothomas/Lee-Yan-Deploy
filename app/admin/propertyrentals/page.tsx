...
import AllPropertyCard from '@/app/aahooks/AllPropertyCard';
...
const AdministratorsPage = async ({ searchParams, tourParams, listingParams, propertyParams, landParams }: HotelPageProps) => {
  ...
  //   }));
    ...
    const reservations = properties.filter(property => property.type === "rental");
        ...
        <Container>
          <div className="grid grid-cols-6 gap-10 pt-16">
            ...
            <div className="col-span-4">
              ...
              <div className="pb-2">
               <h1 className="text-xl font-semibold">All property rentals</h1>
                </div>
